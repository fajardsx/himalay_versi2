...
import Septilin_page1_pop1_core from "./septilin_page1_pop1";
import Septilin_page1_pop2_core from "./septilin_page1_pop2";
import Septilin_page1_pop3_core from "./septilin_page1_pop3";
import Others_page1_clinical from "../others/others_page1_clinical";


let path = '../../../../../assets/edetailing/';
class Septilin_page1_core extends React.Component {
  ...
  _popShow(id = 0) {
    if (id == 0) {
     ...
     return <Septilin_page1_pop1_core onclose={this._onBtnPopClosePress.bind(this)} />;
    } else if (id == 2) {
      return <Septilin_page1_pop2_core onclose={this._onBtnPopClosePress.bind(this)} />;
    } else if (id == 3) {
      return <Septilin_page1_pop3_core onclose={this._onBtnPopClosePress.bind(this)} />;
    } else if (id == 4) {
    ...
    return (
      ...
      >
        ...
        <Animated.Image
          ...
          resizeMode={"contain"}
          source={require(path + "septilin1/info.png")}
        />
        ...
        <Animated.Image
          ...
          resizeMode={"contain"}
          source={require(path + "septilin1/obat.png")}
        />
        ...
        <Animated.Image
          ...
          resizeMode={"contain"}
          source={require(path + "septilin1/title1.png")}
        />
...
*/
export default Septilin_page1_core;