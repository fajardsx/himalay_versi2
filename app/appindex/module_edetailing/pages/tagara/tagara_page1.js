...
import Tagara_page1_pop1_core from "./tagara_page1_pop1";
import Tagara_page1_pop2_core from "./tagara_page1_pop2";
import Tagara_page1_pop3_core from "./tagara_page1_pop3";
import Others_page3_clinical from "../others/others_page3_clinical";


let path = '../../../../../assets/edetailing/';
class Tagara_page1_core extends React.Component {
  ...
  _popShow(id = 0) {
    if (id == 0) {
      return null;
        ...
        return <Tagara_page1_pop1_core onclose={this._onBtnPopClosePress.bind(this)} />;
    } else if (id == 2) {
        return <Tagara_page1_pop2_core onclose={this._onBtnPopClosePress.bind(this)} />;
    } else if (id == 3) {
      return <Tagara_page1_pop3_core onclose={this._onBtnPopClosePress.bind(this)} />;
    } else if (id == 4) {
    ...
    return (
      ...
      >
        ...
        <Animated.Image
          ...
          resizeMode={"contain"}
          source={require(path + "tagara1/info.png")}
        />
        ...
        <Animated.Image
          ...
          resizeMode={"contain"}
          source={require(path + "tagara1/obat.png")}
        />
        ...
        <Animated.Image
          ...
          resizeMode={"contain"}
          source={require(path + "tagara1/title.png")}
        />
        ...
        <Animated.Image
          ...
          resizeMode={"contain"}
          source={require(path + "septilin1/ref.png")}
        />
  ...
  startAnim() {
    Animated.sequence([
      ...
      Animated.parallel([
        ...
        Animated.spring(this.xTitle, { toValue: { x: convertWidth('45%'), y: convertHeight('20%') }, duration: 3000 })
      ]),
      ...
      Animated.parallel([
        ...
        Animated.spring(this.xinfo, { toValue: { x: convertWidth('20%'), y: convertHeight('36%') }, duration: 1000 })
      ]),
...
*/
export default Tagara_page1_core;