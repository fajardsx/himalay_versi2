...
class Tagara_page1_pop3_core extends React.Component {
          ...
          <View style={{ position: 'absolute', top: convertHeight('15%')}}>
            <View style={{ width: convertWidth("80%"),alignItems: 'center' }}>
              <Image
                ...
                resizeMode={"contain"}
                source={require(path + "tagara1/pop3_img1.png")}
              />
            ...
            <View style={{ alignItems: 'center',marginHorizontal:convertWidth('2%') }}>
              <Image
                ...
                resizeMode={"contain"}
                source={require(path + "tagara1/pop3_img2.png")}
              />
...
*/
export default Tagara_page1_pop3_core;