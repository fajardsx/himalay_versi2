...
class Liv52ds_page3_pop1_core extends React.Component {
        ...
        <View style={{
         ...
         // position: 'absolute',
          ...
          <LinearGradient start={{ x: 0.0, y: 0.0 }}
            ...
            locations={[0, 0.9]} colors={["#0D9B86", "#008778"]} style={{
              width: convertWidth("80%"),
            ...
            }}>{"Liv.52 DS Indikasi"}</Text>
          </LinearGradient>
         
          <View style={{ flexDirection: 'row', position: 'absolute', top: convertHeight('19%'), left: convertHeight('8%')}}>
            <View style={{ alignItems: 'center' }}>
              <Image
                ...
                resizeMode={"contain"}
                source={require(path + "liv52ds3/pop1_img2.png")}
              />
            </View>
...
*/
export default Liv52ds_page3_pop1_core;