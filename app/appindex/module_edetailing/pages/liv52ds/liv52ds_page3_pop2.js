...
class Liv52ds_page3_pop2_core extends React.Component {
        ...
        <View style={{
         ...
         // position: 'absolute',
          ...
          <LinearGradient start={{ x: 0.0, y: 1.0 }}
            ...
            locations={[0, 0.9]} colors={["#CC3920", "#EA5B1B"]} style={{
              width: convertWidth("80%"),
            ...
            }}>{"Liv.52 DS Dosis"}</Text>
          </LinearGradient>
          <View style={{ flexDirection: 'row', position: 'absolute', top: convertHeight('14%'), left: convertHeight('3%')}}>
            <View style={{ alignItems: 'center' }}>
              <Image
                ...
                resizeMode={"contain"}
                source={require(path + "liv52ds3/pop2_img2.png")}
              />
            </View>
...
*/
export default Liv52ds_page3_pop2_core;