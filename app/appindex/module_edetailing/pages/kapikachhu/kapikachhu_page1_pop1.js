...
class Kapikachhu_page1_pop1_core extends React.Component {
        ...
        return (
          ...
          >
            ...
            <Animated.Image
              ...
              resizeMode={"contain"}
              source={require(path + "kapikachhu1/pop1.png")}
            />
           
            <Animated.View style={{
              left: convertWidth("83.5%"),
...
*/
export default Kapikachhu_page1_pop1_core;