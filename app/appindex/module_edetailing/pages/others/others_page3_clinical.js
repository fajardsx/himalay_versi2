...
class Others_page3_clinical extends React.Component {
      ...
      >
        ...
        <View style={{
          ...
          <Animated.View style={{
            ...
            <TouchableOpacity
              onPress={() => this.props.showPdf('Tagara Sleep Wellness', '/data/user/0/com.himalaya/files/files64.pdf')}
            >
              <Image
                style={{
                ...
                resizeMode={"contain"}
                source={require(path + "others1/tagara_pdfbox.png")}
              />
            </TouchableOpacity>
          </Animated.View>
...
*/
export default Others_page3_clinical;