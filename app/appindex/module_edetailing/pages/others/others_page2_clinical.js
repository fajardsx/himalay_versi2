...
class Others_page2_clinical extends React.Component {
      ...
      >
        ...
        <View style={{
          ...
          <Animated.View style={{
            ...
            <TouchableOpacity
              onPress={() => this.props.showPdf('Ayuslim Obesitas', '/data/user/0/com.himalaya/files/files60.pdf')}
            >
              <Image
                style={{
                ...
                resizeMode={"contain"}
                source={require(path + "others1/ayurslim_pdfbox.png")}
              />
            </TouchableOpacity>
          </Animated.View>
...
*/
export default Others_page2_clinical;