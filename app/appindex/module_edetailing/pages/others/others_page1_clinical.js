...
class Others_page1_clinical extends React.Component {
      ...
      >
        ...
        <View style={{
          ...
          <Animated.View style={{
            ...
            <TouchableOpacity
              onPress={() => this.props.showPdf('The Pontent Immunomodulator', '/data/user/0/com.himalaya/files/files99.pdf')}
            >
              <Image
                style={{
                ...
                resizeMode={"contain"}
                source={require(path + "others1/septilin_pdfbox.png")}
              />
            </TouchableOpacity>
          </Animated.View>
          ...
          <Animated.View style={{
            ...
            <TouchableOpacity
              onPress={() => this.props.showPdf('Septilin ISPA', '/data/user/0/com.himalaya/files/files59.pdf')}
            >
              <Image
                style={{
                ...
                resizeMode={"contain"}
                source={require(path + "others1/septilin_pdfbox2.png")}
              />
            </TouchableOpacity>
          </Animated.View>
...
*/
export default Others_page1_clinical;