...
class Others_page4_clinical extends React.Component {
      ...
      >
        ...
        <View style={{
          ...
          <Animated.View style={{
            ...
            <TouchableOpacity
              onPress={() => this.props.showPdf('Lasuna Cardio Wellness', '/data/user/0/com.himalaya/files/files65.pdf')}
            >
              <Image
                style={{
                ...
                resizeMode={"contain"}
                source={require(path + "others1/lasuna_pdfbox.png")}
              />
            </TouchableOpacity>
          </Animated.View>
...
*/
export default Others_page4_clinical;