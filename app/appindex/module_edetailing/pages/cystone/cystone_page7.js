...
class Cystone_page7_core extends React.Component {
    ...
    constructor(props) {
      ...
      this.posobat = new Animated.ValueXY({ x: convertWidth("32%"), y: convertHeight("27%") })
      this.posicon1 = new Animated.ValueXY({ x: convertWidth("10%"), y: convertHeight("40%") })
      this.posicon2 = new Animated.ValueXY({ x: convertWidth("55%"), y: convertHeight("40%") })
    }
    componentDidMount() {
    ...
    Animated.sequence([
      ...
      Animated.parallel([
        ...
        Animated.spring(this.posobat, {
          toValue: { x: convertWidth("32%"), y: convertHeight("37%") },
          duration: 3000
        })
      ]),
      Animated.parallel([
        ...
        Animated.spring(this.posicon1, {
          toValue: { x: convertWidth("10%"), y: convertHeight("40%") },
          duration: 1000
        })
      ]),
      Animated.parallel([
        ...
        Animated.spring(this.posicon2, {
          toValue: { x: convertWidth("68%"), y: convertHeight("40%") },
          duration: 1000
        })
      ]),
      Animated.delay(300),
