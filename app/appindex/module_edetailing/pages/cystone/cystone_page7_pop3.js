...
class Cystone_page7_pop3_core extends React.Component {
          ...
          >
            ...
            <Animated.Image
              style={{
                ...
                left: convertWidth("5%"),
                top: convertHeight("11%"),
                //backgroundColor:'#000'
              }}
              resizeMode={"contain"}
              source={require(path + "cytone6/cystonepopbg3.png")}
            />
            <Animated.Image
              style={{
                position: "absolute",
              ...
              resizeMode={"contain"}
              source={require(path + "cytone6/cystonepopbg3_title.png")}
            />
            <Animated.Image
              style={{
                position: "absolute",
                ...
                left: convertWidth("14%"),
                top: convertHeight("33%"),
                //backgroundColor:'#000'
              }}
              resizeMode={"contain"}
              source={require(path + "cytone6/cystonepopbg3_part1.png")}
            />

           

            <Animated.View style={{
              left: convertWidth("87%"),
              top: convertHeight("8%"), position: "absolute",
            }}>
              <TouchableOpacity
...
*/
export default Cystone_page7_pop3_core;