...
class Cystone_page7_pop2_core extends React.Component {
        ...
        return (
          ...
          >
            ...
            <Animated.Image
              ...
              resizeMode={"contain"}
              source={require(path + "cytone6/cystonepopbg2.png")}
            />
            <Animated.Image
              style={{
                position: "absolute",
                width: convertWidth("84%"),
              ...
              resizeMode={"contain"}
              source={require(path + "cytone6/cystonepopbg2_part1.png")}
            />

            <Animated.View style={{
              left: convertWidth("93%"),
              top: convertHeight("10%"), position: "absolute",
            }}>
              <TouchableOpacity
...
*/
export default Cystone_page7_pop2_core;