...
class Cystone_page4_core extends React.Component {
    ...
    constructor(props) {
        ...
        this.posTable = new Animated.ValueXY({ x: convertWidth('8%'), y: convertHeight('50%') });
    }
    componentDidMount() {
          ...
          >
            ...
            <Animated.Image
              style={{
                ...
                left: convertWidth("46%"),
                top: convertHeight("33.2%"),
    ...
    startAnim(){
      Animated.sequence([
        ...
        Animated.timing(this.fadesubtitle2, { toValue: 1, duration: Constant.DURATION_FADE }),
        Animated.timing(this.fadesubtitle3, { toValue: 1, duration: Constant.DURATION_FADE }),
        Animated.parallel([
          Animated.timing(this.fadetable, { toValue: 1, duration: 1000 }),
          Animated.spring(this.posTable, { toValue: { x: convertWidth('8%'), y: convertHeight('32%') }, duration: 3000 })
        ]),
        ...
        Animated.timing(this.fadeicon3, { toValue: 1, duration: Constant.DURATION_FADE }),
