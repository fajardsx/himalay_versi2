...
class Shatavari_page2_core extends React.Component {
    ...
    return (
      ...
      >
        ...
        <Animated.Image
          ...
          resizeMode={"contain"}
          source={require(path + "shatavari1/title2.png")}
        />
        ...
        <Animated.View style={{
          ...
          <TouchableOpacity
            onPress={() => this.props.showPdf('Uji klinis evaluasi efek peningkatan air susu ibu(ASI) dari Asparagus racemosus(Shatavari)', '/data/user/0/com.himalaya/files/files14.pdf')}
          >
            <Image
              style={{
              ...
              resizeMode={"contain"}
              source={require(path + "shatavari1/pdfbox.png")}
            />
          </TouchableOpacity>
        </Animated.View>
      </View>
...
*/
export default Shatavari_page2_core;