...
class Shatavari_page1_pop1_core extends React.Component {
        ...
        <View style={{
         ...
         // position: 'absolute',
          ...
          <LinearGradient start={{ x: 0.0, y: 1.0 }}
            ...
            }}>{"Shatavari Indikasi, Dosis & Komposisi"}</Text>
          </LinearGradient>
          ...
          <View style={{ flexDirection: 'row', position: 'absolute', top: convertHeight('15%'), left: convertHeight('8%')}}>
            <View style={{ alignItems: 'center' }}>
              <Image
                ...
                resizeMode={"contain"}
                source={require(path + "shatavari1/pop1bg_box1.png")}
              />
            </View>
            <View style={{ alignItems: 'center' }}>
              <Image
                ...
                resizeMode={"contain"}
                source={require(path + "shatavari1/pop1bg_box2.png")}
              />
            </View>
          </View>
          <View style={{ alignItems: 'center', position: 'absolute', top: convertHeight('44%'), left: convertHeight('6%') }}>
            <Image
              ...
              resizeMode={"contain"}
              source={require(path + "shatavari1/pop1bg_box3.png")}
            />
          </View>
          <View style={{ alignItems: 'center', position: 'absolute', top: convertHeight('14%'), left: convertHeight('90%')}}>
            <Image
              ...
              resizeMode={"contain"}
              source={require(path + "shatavari1/obat.png")}
            />
          </View>
        </View>
...
*/
export default Shatavari_page1_pop1_core;