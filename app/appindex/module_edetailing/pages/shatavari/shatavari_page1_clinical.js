...
class Shatavari_page1_clinical extends React.Component {
      ...
      >
        ...
        <View style={{
          ...
          <Animated.View style={{
            ...
            <TouchableOpacity
              onPress={() => this.props.showPdf('Uji klinis evaluasi efek peningkatan air susu ibu(ASI) dari Asparagus racemosus(Shatavari)', '/data/user/0/com.himalaya/files/files80.pdf')}
            >
              <Image
                style={{
...
*/
export default Shatavari_page1_clinical;