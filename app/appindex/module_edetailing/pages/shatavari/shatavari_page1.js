...
import Shatavari_page1_pop1_core from "./shatavari_page1_pop1";
import Shatavari_page1_clinical from "./shatavari_page1_clinical";


let path = '../../../../../assets/edetailing/';
class Shatavari_page1_core extends React.Component {
  ...
  constructor(props) {
    ...
    this.xTitle = new Animated.ValueXY({ x: convertWidth('63%'), y: convertHeight('12%') });
  ...
  _popShow(id = 0) {
    if (id == 0) {
      ...
      return <Shatavari_page1_pop1_core  onclose={this._onBtnPopClosePress.bind(this)} />;  
    } else if (id == 2) {
      return <Shatavari_page1_clinical showPdf={this.props.showPdf.bind(this)}  onclose={this._onBtnPopClosePress.bind(this)} />;
    }  
    ...
    return (
      ...
      >
        ...
        <Animated.Image
          ...
          resizeMode={"contain"}
          source={require(path + "shatavari1/title1.png")}
        />
        <Animated.Image
          style={
            {
              position: "absolute",
              width: convertWidth("73%"),
          ...
          resizeMode={"contain"}
          source={require(path + "shatavari1/titlesub.png")}
        />
        <View style={{
          flexDirection: 'row',
          position: "absolute",
          ...
          <Animated.Image
            ...
            resizeMode={"contain"}
            source={require(path + "shatavari1/box1.png")}
          />
          <Animated.Image
            style={
              {
            ...
            resizeMode={"contain"}
            source={require(path + "shatavari1/box2.png")}
          />
        </View>
          ...
          style={
            {
              ...
              top: convertHeight('36%'),
              //borderWidth: 1,
              //backgroundColor: '#000',
            }
          }
          resizeMode={"contain"}
          source={require(path + "shatavari1/content.png")}
        />
  ...
  startAnim() {
    Animated.sequence([
      ...
      Animated.parallel([
        ...
        Animated.spring(this.xTitle, { toValue: { x: convertWidth('7%'), y: convertHeight('14%') }, duration: 3000 })
      ]),
      Animated.parallel([
...
*/
export default Shatavari_page1_core;