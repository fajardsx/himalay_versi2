...
class Gokshura_page2_core extends React.Component {
    ...
    return (
      ...
      >
        ...
        <Animated.Image
          ...
          resizeMode={"contain"}
          source={require(path + "gokshura/title2.png")}
        />
        ...
        <Animated.View style={{
          ...
          <TouchableOpacity
            onPress={() => this.props.showPdf('Tribulus terrestris (Gokshura) untuk pengobatan disfungsi seksual pada wanita', '/data/user/0/com.himalaya/files/files14.pdf')}
          >
            <Image
              style={{
...
*/
export default Gokshura_page2_core;