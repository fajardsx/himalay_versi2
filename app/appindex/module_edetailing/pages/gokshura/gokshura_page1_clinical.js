...
class Gokshura_page1_clinical extends React.Component {
      ...
      >
        ...
        <View style={{
          ...
          <Animated.View style={{
            ...
            left: convertWidth('3%'),
            top: convertHeight('28%'), position: "absolute"
          }}>
            <TouchableOpacity
              onPress={() => this.props.showPdf('Tribulus terrestris (Gokshura) untuk pengobatan disfungsi seksual pada wanita', '/data/user/0/com.himalaya/files/files81.pdf')}
            >
              <Image
                style={{
                ...
                resizeMode={"contain"}
                source={require(path + "gokshura/pdfbox.png")}
              />
            </TouchableOpacity>
          </Animated.View>
        </View>
...
*/
export default Gokshura_page1_clinical;