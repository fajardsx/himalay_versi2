...
class Gokshura_page1_core extends React.Component {
  ...
  constructor(props) {
    ...
    this.xTitle = new Animated.ValueXY({ x: convertWidth('63%'), y: convertHeight('8%') });
  ...
  _popShow(id = 0) {
    if (id == 0) {
     ...
     return <Gokshura_page1_pop1_core onclose={this._onBtnPopClosePress.bind(this)} />;
    } else if (id == 2) {
      return <Gokshura_page1_clinical showPdf={this.props.showPdf.bind(this)} onclose={this._onBtnPopClosePress.bind(this)} />;
    } else if (id == 3) {
    ...
    return (
      ...
      >
        ...
        <View style={{
          flexDirection: 'row',
          alignItems: 'center',
          left: convertWidth("80%"), top: convertHeight("81%"), position: "absolute"
        }}>
          <Animated.View style={{
  ...
  startAnim() {
    Animated.sequence([
      ...
      Animated.parallel([
        ...
        Animated.spring(this.xTitle, { toValue: { x: convertWidth('7%'), y: convertHeight('13%') }, duration: 3000 })
      ]),
      Animated.parallel([
