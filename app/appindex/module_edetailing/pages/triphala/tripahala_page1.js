...
import Tripahala_page1_pop1_core from "./tripahala_page1_pop1";
import Tripahala_page1_pop2_core from "./tripahala_page1_pop2";
import Tripahala_page1_pop3_core from "./tripahala_page1_pop3";
import Triphala_page1_clinical from "./triphala_page1_clinical";

let path = '../../../../../assets/edetailing/';
class Tripahala_page1_core extends React.Component {
  ...
  _popShow(id = 0) {
    if (id == 0) {
      ...
      return <Tripahala_page1_pop1_core onclose={this._onBtnPopClosePress.bind(this)} />;
    } else if (id == 2) {
      return <Tripahala_page1_pop2_core onclose={this._onBtnPopClosePress.bind(this)} />;
    } else if (id == 3) {
      return <Tripahala_page1_pop3_core onclose={this._onBtnPopClosePress.bind(this)} />;
    } else if (id == 4) {
      return <Triphala_page1_clinical showPdf={this.props.showPdf.bind(this)} onclose={this._onBtnPopClosePress.bind(this)} />;
    } 
    ...
    return (
      ...
      >
        ...
        <Animated.Image
          ...
          resizeMode={"contain"}
          source={require(path + "tripala1/info.png")}
        />
        ...
        <Animated.Image
          ...
          resizeMode={"contain"}
          source={require(path + "tripala1/obat.png")}
        />
        ...
        <Animated.Image
          ...
          resizeMode={"contain"}
          source={require(path + "tripala1/title.png")}
        />
        ...
        <Animated.Image
          ...
          resizeMode={"contain"}
          source={require(path + "tripala1/ref.png")}
        />
        <Animated.View style={{
...
*/
export default Tripahala_page1_core;