...
class Triphala_page1_clinical extends React.Component {
        ...
        <View style={{
          ...
          <Animated.View style={{
            ...
            <Image
              ...
              resizeMode={"contain"}
              source={require(path + "tripala1/pdfbox.png")}
            />
          ...
          <TouchableOpacity
            ...
            onPress={() => this.props.showPdf('Triphala Prokinetic Cleanser', '/data/user/0/com.himalaya/files/files61.pdf')}
          >
          </TouchableOpacity>
...
*/
export default Triphala_page1_clinical;