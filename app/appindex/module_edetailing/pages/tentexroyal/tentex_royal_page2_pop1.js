...
class Tentex_royal_page2_pop1_core extends React.Component {
        ...
        return (
          ...
          >
            ...
            <Animated.Image
              ...
              resizeMode={"contain"}
              source={require(path + "tentexroyal2/pop1.png")}
            />
            <View style={{flexDirection: 'row',
           position: "absolute",
              left: convertWidth("12%"),
              top: convertHeight("44%"),
            }}>
              <Animated.Image
                style={{
                  //position: "absolute",
                ...
                resizeMode={"contain"}
                source={require(path + "tentexroyal2/pop1_box1.png")}
              />
              <Animated.Image
                style={{
                 // position: "absolute",
                ...
                resizeMode={"contain"}
                source={require(path + "tentexroyal2/pop1_box2.png")}
              />
            </View>
           
            <Animated.View style={{
              left: convertWidth("92.5%"),
...
*/
export default Tentex_royal_page2_pop1_core;