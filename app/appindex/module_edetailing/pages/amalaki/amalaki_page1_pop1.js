...
class Amalaki_page1_pop1_core extends React.Component {
          ...
          <View style={{ flexDirection: 'row', position: 'absolute', top: convertHeight('20%'), left: convertHeight('10%')}}>
            <View style={{ alignItems: 'center' }}>
              <Image
                ...
                resizeMode={"contain"}
                    source={require(path + "amalaki1/pop1_img1.png")}
              />
              <Text style={{
            ...
            <View style={{ alignItems: 'center',marginHorizontal:convertWidth('5%') }}>
              <Image
                style={{
                ...
                resizeMode={"contain"}
                    source={require(path + "amalaki1/pop1_img2.png")}
              />
              <Text style={{
                marginTop: convertHeight('5%'),
                color: "#C06F00",
            ...
            <View style={{ alignItems: 'center' }}>
              <Image
                ...
                resizeMode={"contain"}
                    source={require(path + "amalaki1/pop1_img3.png")}
              />
              <Text style={{
                marginTop: convertHeight('5%'),
                color: "#C06F00",
...
*/
export default Amalaki_page1_pop1_core;