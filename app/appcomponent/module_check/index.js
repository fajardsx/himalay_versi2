...
class CheckComponent extends Component{
    ...
    _setCheckIcon(_type) {
        ...
        let _sizeicons = '2.7%';
        if (_type == 0){
            return <View style={{ alignItems: 'center', justifyContent: 'center', width: convertWidth(_sizecontiner), height: convertWidth(_sizecontiner) }}>
    ...
    _setCheckEmptyIcon(_color) {
        ...
        let _sizem = '3.5%';
        let _sizeicons = '3.7%';
        return <View style={{ alignItems: 'center', justifyContent: 'center', width: convertWidth(Constant.COLOR_GRAY2), height: convertWidth(_sizecontiner) }}>
           
                <View
                style={{ borderRadius: convertWidth("1%"),
    ...
    render(){
        ...
        return <View style={this.props.stylecheck ? this.props.stylecheck:stylemenu.contianer}>
            <TouchableOpacity
...
const stylemenu = StyleSheet.create({
    ...
    textmenu: {
        fontFamily: Constant.POPPINS_MEDIUM, fontSize: 21, color: "#fff"
    },
    btncontainer: {
        width: '100%', height: 80, alignItems: 'center', flexDirection: 'row', marginLeft: "5%"
    },
    linecontainer: {
        width: '100%', borderColor: "#04665B", borderBottomWidth: 1,
    }
})
