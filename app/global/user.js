...
import { sendCurrentLocation, getReverseGeo, formateFullDateNumber, getDoctorById, callToast } from './Global';
import { SYNCLoc, F_I_F_O_GLOBAL_LOC, LEMARI_GLOBAL_LOC } from '../appcomponent/module_async/AsyncManager';
...
class user{
    ...
    static onUpdateUserDataLocal(data) {
        ...
        userData.profile_country = data.profile_country ? data.profile_country : "INDONESIA";
        //if (pass != null) {
