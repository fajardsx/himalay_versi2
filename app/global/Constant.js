...
class Constant {
  ...
  static TIMECUERRENT_BUILD = "1755";
  static NAME_VERSION = "20190904_" + this.CUERRENT_BUILD + "_" + this.TIMECUERRENT_BUILD;

  //link googleplay
  static GOOGLEPLAY_LINK = "https://beta2.dotcomsolution.co.id/apk/himalaya.apk";
  //SET Up
  static initinf0 = [];
  //api rest method
  static P = "post";
  ...
  static rest_url = this.SERVER_ID == 1 ? "https://beta2.dotcomsolution.co.id/himalaya/public/api/" : "http://52.220.37.245/public/api/";
  static RESTLINK = "";
  static BASELINK = "";
  static HEADER_2 = {
  ...
  //DEV MODE
  static DEFAULT_REST_URL = this.SERVER_ID == 0 ? "https://beta2.dotcomsolution.co.id/himalaya/public/api/" : "http://3.1.201.136/public/api/";
