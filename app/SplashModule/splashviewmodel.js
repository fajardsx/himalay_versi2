...
import {moderateScale, verticalScale} from '../styleapp/scaling';
...
const slides = [
  {
    ...
    des:
      'Save Your Cost By going digital, you can save cost of printing, distribution, and transportation.',
  ...
  },
  {
    ...
    des:
      'Monitor Your Resources Easily track and monitor your employees and their work.',
...
class SplashScreen extends React.Component {
  ...
  _renderDoneButton = () => {
    return (
      <View style={{width: '100%', backgroundColor: 'rgba(0,0,0,1)'}}>
        <Text>{'SKIP'}</Text>
      </View>
    );
  };
    ...
    return (
      <View
        style={[
          ...
          {
            flex: 1,
            paddingHorizontal: moderateScale(140),
        ...
        <View style={{flex: 1}}>
          <Image
            style={[props.item.imageStyle, {backgroundColor: '#fff'}]}
            resizeMode={'contain'}
